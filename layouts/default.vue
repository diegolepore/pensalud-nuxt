    ...
    <footer id="footer" class="w-full bg-indigo-600">
      <div class="w-11/12 max-w-screen-xl mx-auto h-20 flex justify-between py-5 items-center">
        <div class="text-white flex flex-col flex-grow-0">
          ...
          <div class="nav__logo-name inline-block text-xs font-sans font-bold text-gray-100 bg-indigo-600 px-4">
            <a href="#">Dra. Diana Rodríguez</a>
          </div>
        </div>
        <div class="text-white">
          <div class="flex">
            <a class="ml-3 link" href="https://twitter.com/diana78503135" target="_blank" data-tippy-content="@twitter_handle">
              <svg class="h-6 fill-current text-white hover:text-gray-400" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title>Twitter</title>
